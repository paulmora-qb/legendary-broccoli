...
# legendary_broccoli documentation build
...
from legendary_broccoli import __version__ as release
...
htmlhelp_basename = "legendary_broccolidoc"
...
texinfo_documents = [
    (
        ...
        author,
        "legendary_broccoli",
        "Project legendary_broccoli codebase.",
        "Data-Science",
    )
]
